...
* [Guidelines for remote connection to the database](https://community.synology.com/enu/forum/1/post/120485)
...
to a subset of users. Don't forget to set the ip and port to point to your NAS. The links above will help you with this step. 
...
ip = ...
port = ...
conection = get_connection(ip, port)
